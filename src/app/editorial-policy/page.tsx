  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      ...
      <p className="text-sm leading-relaxed mb-10">
        ぬりえプリントでは、ご家庭でお子さまと過ごす方々、そして保育園・幼稚園・教室で関わる方々に安心して使っていただけるよう、教材とコラム記事の作成にあたって以下の方針を定めています。掲載する情報の質と信頼性を維持するために、当サイトが守っている基準を公開します。
      </p>
      ...
      <section className="mb-10">
        ...
        <ol className="space-y-3 text-sm leading-relaxed list-decimal pl-5">
          ...
          <li>
            <strong>記事の執筆</strong>：ご家庭・教育現場で実際に役立つ視点を意識して書きます。一般論にとどまらず、具体的な活用シーンを示すようにしています
          </li>
          <li>
      ...
      <section className="mb-10">
        ...
        <ul className="space-y-2 text-sm leading-relaxed list-disc pl-5">
          ...
          <li>発達面で気になる点がある場合は、小児科医・専門機関にご相談ください</li>
        </ul>
      </section>
